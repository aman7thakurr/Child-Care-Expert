...
function Newsletter() {
  return (
    <section className="relative  max-w-custom pt-[200px] right-[312px] left-[312px] py-20 md:py-24 overflow-hidden">
      <div className="relative  max-w-custom   px-4 mx-auto">
        <div
          className="relative max-w-7xl      mx-auto px-8 pt-16 pb-18 md:pb-24 overflow-hidden "
          style={{
            backgroundImage: 'url(https://websitedemos.net/childcare-blog-02/wp-content/uploads/sites/760/2021/01/child-care-template-cta-blob-shape-bg.svg)',
            backgroundRepeat: 'no-repeat'
          }}
        >
          <div className="relative max-w-md mx-auto">
            <h4 className="font-heading text-center text-4xl sm:text-5xl text-black font-semibold mb-12">
            ...
            <div className="sm:flex mb-2 items-center">
              ...
              />
              <button
                className="relative group inline-block flex-shrink-0 w-full sm:w-auto py-3 px-5 text-sm font-semibold text-orange-50 bg-blue-900 rounded-md overflow-hidden"
                type="submit"
              >
            ...
            <span className="block text-xs font-semibold text-black">
              ...
              <a className="inline-block underline text-black" href="#">
                privacy policy
              </a>
            </span>
          </div>
